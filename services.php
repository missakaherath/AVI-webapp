				...
				<div class="top-menu">
					<span class="menu"><img src="images/nav.png" alt=""/> </span>
						<ul>
							...
							<li><a href="addGeneralUser.php">racing</a></li>
							<li><a href="typo.html">typo</a></li>
							<li><a href="addAdmin.php">contact</a></li>
						</ul>
				</div>
				<div class="search">
					<div class="b-search">
				...
				<h3>what we offer</h3>
					<div class="service-grids">
						...
						<ul>
							...
							<li><a href="#">Dapibus pulvinonec eget tellus non era</a></li>
							<li><a href="#">Tincidunt ac, viverraonec porta diam eu</a></li>
							<li><a href="#">Lorem ipsum dolor sit</a></li>
							<li><a href="#">Vestibulum ante faucibus orci ltrices</a></li>
						</ul>
						</div>
